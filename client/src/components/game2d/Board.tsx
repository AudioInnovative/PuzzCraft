    ...
    <canvas
      ...
      style={{ 
        ...
        cursor: selectedBlockPos 
          ? `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><defs><filter id="glow" x="-30%" y="-30%" width="160%" height="160%"><feGaussianBlur stdDeviation="2.5" result="blur"/><feComposite in="SourceGraphic" in2="blur" operator="over"/></filter></defs><circle cx="24" cy="24" r="5" fill="%23FFFFFF" /><path d="M24 6 L24 15 M24 33 L24 42 M6 24 L15 24 M33 24 L42 24" stroke="%23000000" stroke-width="4" /><path d="M24 6 L24 15 M24 33 L24 42 M6 24 L15 24 M33 24 L42 24" stroke="%23FFCC00" stroke-width="2.5" filter="url(%23glow)" /><circle cx="24" cy="24" r="20" stroke="%23FFCC00" stroke-width="2.5" stroke-dasharray="4,4" fill="none" filter="url(%23glow)" /></svg>') 24 24, auto`
          : gamePhase === "editing"
            ? `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><defs><filter id="glow" x="-30%" y="-30%" width="160%" height="160%"><feGaussianBlur stdDeviation="2.5" result="blur"/><feComposite in="SourceGraphic" in2="blur" operator="over"/></filter></defs><circle cx="24" cy="24" r="5" fill="%23FFFFFF" /><path d="M10 24 L38 24 M24 10 L24 38" stroke="%23000000" stroke-width="4" /><path d="M10 24 L38 24 M24 10 L24 38" stroke="%23FF6600" stroke-width="2.5" filter="url(%23glow)" /><circle cx="24" cy="24" r="18" stroke="%23FF6600" stroke-width="2.5" fill="none" filter="url(%23glow)" /></svg>') 24 24, auto`
